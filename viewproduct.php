...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <ul class="navbar-nav">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" style="margin-top:30px;margin-bottom:30px"><center>
                <img src="img/<?php echo $pro_img1;?>" alt="" style="height:400px;width:340px;margin-bottom:10px;"><br>
                <img src="img/<?php echo $pro_img1;?>" alt="" style="height:150px;width:110px">
                <img src="img/<?php echo $pro_img2;?>" alt="" style="height:150px;width:110px">
                <img src="img/<?php echo $pro_img3;?>" alt="" style="height:150px;width:110px">
                </center>
            
            </div>
            
            
            <div class="col-md-6" style="margin-top:30px;margin-bottom:30px;font-family:comic sans MS">
                <div class="card" style="margin-bottom:30px;text-style:none;font-color:#292321">
					<div class="card-body">
						<ul class="navbar-nav">
							<li class="nav-item active">
											
								<h1 ><a href="" style="color:#292321">Goods Detail</a></h1>
                                <pre>Description: <?php echo $pro_desc; ?></pre>
                                <p><span>Price:<b><?php echo  $pro_price; ?> </b>tk</span></p>
                                <hr>
                                <h1 ><a href="" style="color:#292321">Seller Details</a></h1>
                                <p>Seller Name:  <?php echo $admin_name; ?></p>
                                <p>Seller Email: <?php echo $admin_email; ?></p>
                                <p>Seller Phone: <?php echo $admin_contact; ?></p>
							</li>
						</ul>
					</div>
				</div>
            ...
            <div class="col-md-6">
                  <h2 style="margin-top:30px;"> Related Products </h2>
                  <hr>
